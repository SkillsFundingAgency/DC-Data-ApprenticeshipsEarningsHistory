CREATE TABLE [Staging].[AppsEarningsHistoryStaged] (
    ...
    CONSTRAINT [PK_Staging_AppsEarningsHistory] PRIMARY KEY CLUSTERED ([LatestInYear] DESC, [LearnRefNumber] ASC, [UKPRN] ASC, [CollectionYear] ASC, [CollectionReturnCode] ASC, [AppIdentifier] ASC)
);
GO

GRANT ALTER ON OBJECT::Staging.[AppsEarningsHistoryStaged] TO [AppsEarningsHistory_RW_User];
